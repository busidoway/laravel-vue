                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu py-0">
                                    <router-link class="dropdown-item" :to="{ name: 'TypeProgramsEdit', params: { id: item.id } }"><span class="fas fa-edit me-2"></span>Редактирование</router-link>
...
export default {
    ...
    data: () => ({
        ...
        dataTotal: 0,
        dataCount: 10,
        pagePath: '/admin/type_programs/page/',
        pageCurr: 0,
        loading: true,
        status: {
            success: false,
    ...
    methods: {
        ...
        deleteDataItem(id) {
            if(id) {
                axios.delete(`/api/type_program_delete/${id}`)
                    .then(response => {
