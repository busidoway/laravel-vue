<template>
    <div class="event-categories__list">
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu py-0">
                                <router-link class="dropdown-item" :to="{ name: 'EventCategoriesEdit', params: { id: item.id } }"><span class="fas fa-edit me-2"></span>Редактирование</router-link>
...
export default {
    ...
    data: () => ({
        ...
        dataTotal: 0,
        dataCount: 10,
        pagePath: '/admin/event_categories/page/',
        pageCurr: 0,
        loading: true,
        status: {
            success: false,
    ...
    methods: {
        getDataList() {
            axios.get('/api/event_categories')
                .then(response => {
        ...
        deleteDataItem(id) {
            if(id) {
                axios.delete(`/api/event_categories_delete/${id}`)
                    .then(response => {
