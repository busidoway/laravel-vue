                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu py-0">
                                <router-link class="dropdown-item" :to="{ name: 'ReviewsEdit', params: { id: item.id } }"><span class="fas fa-edit me-2"></span>Редактирование</router-link>
...
export default {
    ...
    methods: {
        ...
        deleteDataItem(id) {
            if(id) {
                axios.delete(`/api/reviews_delete/${id}`)
                    .then(response => {
