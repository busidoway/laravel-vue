<template>
    <div class="reviews-categories-list">
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu py-0">
                                <router-link class="dropdown-item" :to="{ name: 'ReviewsCategoriesEdit', params: { id: item.id } }"><span class="fas fa-edit me-2"></span>Редактирование</router-link>
...
export default {
    ...
    data: () => ({
        ...
        dataTotal: 0,
        dataCount: 10,
        pagePath: '/admin/reviews_categories/page/',
        pageCurr: 0,
        loading: true,
        status: {
            success: false,
    ...
    methods: {
        getDataList() {
            axios.get('/api/reviews_categories')
                .then(response => {
        ...
        deleteDataItem(id) {
            if(id) {
                axios.delete(`/api/reviews_categories_delete/${id}`)
                    .then(response => {
